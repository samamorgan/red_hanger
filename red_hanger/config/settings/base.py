...
ROOT_URLCONF = "red_hanger.config.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "red_hanger.config.wsgi.application"
...
MIDDLEWARE = [
    ...
    "red_hanger.util.middleware.HTMXMessageMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "builtins": [
                ...
                "red_hanger.util.templatetags.filters",
            ],
...
ADMINS = [("""Sam Morgan""", "sama4mail@gmail.com")]
...
ACCOUNT_ADAPTER = "red_hanger.user.adapter.HTMXAccountAdapter"

# https://django-allauth.readthedocs.io/en/latest/forms.html#account-forms
ACCOUNT_FORMS = {
    "login": "red_hanger.user.forms.LoginForm",
    "signup": "red_hanger.user.forms.SignupForm",
}
